...
cp -f "$LOG_ROOT/stage3-clone.log" "$WINDOWS_ROOT/logs/" 2>/dev/null || true
cp -f "$LOG_ROOT/stage3-submodules.log" "$WINDOWS_ROOT/logs/"
cp -f "$LOG_ROOT/stage3-git-state.txt" "$WINDOWS_ROOT/manifests/"
